...
public class RegisterPageCRM {

    private final By linkSignUp = By.xpath("//a[normalize-space()='Sign up']");
    ...
    public void openRegisterPage() {
        ...
        WebUI.verifyElementPresent(buttonRegister, "Register page did not open or Register button was not visible.");
    }
    ...
    public void verifySuccessPage() {
        ...
        Assert.assertTrue(currentUrl.contains("company-setup")
                ...
                "Registration did not navigate to the expected success page. Current URL: " + currentUrl);
    }
    ...
    public void verifyWhitespaceTrimmed() {
