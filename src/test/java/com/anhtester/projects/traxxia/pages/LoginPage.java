...
public class LoginPage {
    ...
    private final By popupTitle = By.xpath("//div[contains(@class,'error-modal-container')]//h5 | //h5[contains(normalize-space(),'Login Failed')]");
    private final By popupMessage = By.xpath("//div[contains(@class,'error-modal-container')]//p | //p[contains(normalize-space(),'Invalid')]");
    ...
    private final By dashboardMarker = By.xpath("//*[contains(normalize-space(),'Executive Summary') or contains(normalize-space(),'Where to Compete') or contains(normalize-space(),'AHA INSIGHTS')]");
    ...
    public void verifyDashboardPage() {
        WebUI.waitForPageLoaded();
        Assert.assertTrue(
                WebUI.getCurrentUrl().contains("dashboard") || WebUI.checkElementExist(dashboardMarker) || WebUI.checkElementExist(welcomeContent),
